...
But in our case the console the console window is pin code protected. Running the application in devolpment mode locally using the dockerfile we can see how the pin code can be used.
