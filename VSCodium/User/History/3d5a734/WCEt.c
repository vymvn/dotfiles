...
wchar_t *str_replace_all_w(const wchar_t *str, const wchar_t *find, const wchar_t *repl) {
    ...
    // Number of additional replacements to allocate memory for at a time
    ...
    while (match = wcsstr(substr, find)) {
        ...
        // memory has already been allocated for REALLOC_RATE replacements.
...
int num_of_matches_w(const wchar_t *str, const wchar_t *find) {
    const wchar_t *substr = str;
    wchar_t *match;
