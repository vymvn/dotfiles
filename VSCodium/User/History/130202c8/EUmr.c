...
char *format_output(const wchar_t *artist, const wchar_t *title,
    ...
    const int ARTIST_REPL_DIFF = strlen(artist) - wcslen("%artist%");
    const int TITLE_REPL_DIFF = strlen(title) - wcslen("%title%");
