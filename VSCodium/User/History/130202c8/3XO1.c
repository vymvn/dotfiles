...
/*************** Constants for DBus ***************/
const wchar_t *DESTINATION = "org.mpris.MediaPlayer2.spotify";
const wchar_t *PATH = "/org/mpris/MediaPlayer2";

const wchar_t *STATUS_IFACE = "org.freedesktop.DBus.Properties";
const wchar_t *STATUS_METHOD = "Get";
const wchar_t *STATUS_METHOD_ARG_IFACE_NAME = "org.mpris.MediaPlayer2.Player";
const wchar_t *STATUS_METHOD_ARG_PROPERTY_NAME = "Metadata";

const wchar_t *PLAYER_IFACE = "org.mpris.MediaPlayer2.Player";
const wchar_t *PLAYER_METHOD_PLAY = "Play";
const wchar_t *PLAYER_METHOD_PAUSE = "Pause";
const wchar_t *PLAYER_METHOD_PLAYPAUSE = "PlayPause";
const wchar_t *PLAYER_METHOD_NEXT = "Next";
const wchar_t *PLAYER_METHOD_PREVIOUS = "Previous";

const wchar_t *METADATA_TITLE_KEY = "xesam:title";
const wchar_t *METADATA_ARTIST_KEY = "xesam:artist";
...
wchar_t *format_output(const wchar_t *artist, const wchar_t *title,
    ...
    if (max_length == INT_MAX || TOTAL_UNTRUNC_LENGTH > max_length) {
        ...
        wchar_t *temp = str_replace_all(format, "%artist%", trunc_artist);
        wchar_t *temp2 = str_replace_all(temp, "%title%", trunc_title);
        ...
        // Replace all tokens with their values
        wchar_t *temp = str_replace_all(format, "%artist%", artist);
...
void print_usage() {
    ...
    puts("    since the total length is less than 30 wchar_tacters.");
    puts("");
    puts("    spotifyctl status --format '%artist%: %title%' \\");
...
int main(int argc, wchar_t *argv[]) {
    ...
    wchar_t *status_format = "%artist%: %title%";
    wchar_t *trunc = "...";
