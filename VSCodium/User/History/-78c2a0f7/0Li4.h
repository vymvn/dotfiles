 ...
 * @returns wchar_t* The title of the currently playing track
 */
 ...
 *
 * @param DBusMessage* msg The Metadata property DBusMessage
 * @returns wchar_t* The artist of the currently playing track
 */
 ...
 *
 * @param wchar_t* artist The artist name
 * @param wchar_t* title The track title
 ...
 * @param wchar_t* format The format string specifying the output. This can contain
 *                     the %artist% and %title% tokens which will be replaced by
 *                     the artist and title specified in the arguments.
 * @param wchar_t* trunc The string to use to indicate that the artist, title, or
 *                    output was truncated. This will be how the artist, title
 *                    or output ends and will honor the max length constraints.
 *
 * @returns wchar_t* The format string with %artist% replaced by the song artist,
 ...
 *
 * @param DBusConnection* connection The DBusConnection object
 * @param const wchar_t* method The name of the org.mpris.MediaPlayer2.Player
 *                           method to call.
 */
 ...
 * @param wchar_t** argv An array of arguments
 */
